...
// export function setupSlider ( this.preload ) {
// 	let this.curIndex = 0;
// 	let this.loadedIndex = 0;
// 	loadSlide( 0 )
// 	const this.slide_delay = 10000;
// 	let this.autoSlide;
// 	let this.shouldAutoSlide = true;
...
// 			}
// 			if ( this.curIndex > this.loadedIndex - this.preload - 1 && this.loadedIndex < sliderImagesLength ) {
// 				loadSlide( this.curIndex + this.preload )
// 			}
// 		}
// 	}
// 	function goLeft () {
...
// 		this.autoSlide = setInterval( goRight, this.slide_delay )
// 	}
