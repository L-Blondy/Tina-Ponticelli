...
"use strict";function setScrollNav(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.querySelector("body"),o=2<arguments.length&&void 0!==arguments[2]?arguments[2]:.5;document.addEventListener("click",function(e){var t=e.target.getAttribute("href");t&&"#"===e.target.getAttribute("href")[0]&&window.location.replace(t)});var c={threshold:o};try{var r=new IntersectionObserver(function(e){e.forEach(function(e){if(e.intersectionRatio>=c.threshold){var t=e.target.id,o=document.querySelector(".active"),r=document.querySelector('[href="#'.concat(t,'"]'));o&&o.classList.remove("active"),r.classList.add("active"),history.replaceState({},t,"/#".concat(t))}})},c);e.forEach(function(e){r.observe(e)})}catch(e){console.log("The IntersectionObserver API might not be supported by the browser")}t.style.overflowY="scroll",t.style.overflowX="hidden",t.style.scrollBehavior="smooth";var l=document.querySelector("body");l.style.height="100vh",l.style.width="100%",l.style.overflow="hidden",document.querySelector("nav").style.width="100%"}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=setScrollNav;
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/lb-icons/dist/bundle.js":[function(require,module,exports) {
"use strict";require("lb-icons/dist/styles.css");for(var burgers=Array.prototype.slice.call(document.querySelectorAll("[class*=burger-]")),chevrons=Array.prototype.slice.call(document.querySelectorAll("[class*=chevron-]")),icons=burgers.concat(chevrons),i=0;i<icons.length;i++){var container=document.createElement("DIV");if(container.className="lb-container",icons[i].appendChild(container),container.appendChild(document.createElement("DIV")),container.appendChild(document.createElement("DIV")),container.appendChild(document.createElement("DIV")),""===icons[i].getAttribute("rounded"))for(var j=0;j<icons[i].firstChild.children.length;j++)icons[i].firstChild.children[j].style.borderRadius="50px";if(icons[i].getAttribute("thickness"))for(var _j=0;_j<icons[i].firstChild.children.length;_j++)icons[i].classList.contains("chevron-left")?icons[i].firstChild.children[_j].style.width=icons[i].getAttribute("thickness"):icons[i].firstChild.children[_j].style.height=icons[i].getAttribute("thickness");if(icons[i].getAttribute("duration"))for(var _j2=0;_j2<icons[i].firstChild.children.length;_j2++)icons[i].firstChild.children[_j2].style.transitionDuration=icons[i].getAttribute("duration"),icons[i].firstChild.children[_j2].style.animationDuration=icons[i].getAttribute("duration")}
},{"lb-icons/dist/styles.css":"node_modules/lb-icons/dist/styles.css"}],"src/main.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
(0, _lbScrollNav.default)(sections, sectionContainer); //navbar behavior
